...
import numpy as np
'''
two steps for getting metadata
1.run autosklearn
2.parse the log to get metadata
'''
#run auto sklearn on dataset
# input:tuple (x,y)  threadidx: id to distinguish different thread
